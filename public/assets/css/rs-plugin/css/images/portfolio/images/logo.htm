...
<!-- Favicon -->
<link rel="shortcut icon" href="images/redixtouch.bmp" type="image/x-icon">
<link rel="icon" href="images/redixtouch.bmp" type="image/x-icon">
...
<div id="wrap"> 
  ...
  <header class="header coporate-header">
    <div class="sticky">
      <div class="container">
        <div class="logo" style="margin-top:-10px;"> <a href="index"><img src="images/logo.png" alt=""></a> </div>
          ...
          <ul id="ownmenu" class="ownmenu">
            ...
            <li><a href="services">SERVICES</a> 
            	<ul class="dropdown">
            		...
            		<li><a href="html-development">html 5 Development </a> </li>
            		<li><a href="responsive-webdesign">Responsive webdesign</a> </li>
    ...
    <div class="tp-banner-container">
      <div class="tp-banner-fix ">
        <ul>
          ...
          <li data-transition="random" data-slotamount="7"> 
            <!-- MAIN IMAGE --> 
            <img src="images/slides/2.jpg"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat"> 
          ...
          <li data-transition="random" data-slotamount="7"> 
            <!-- MAIN IMAGE --> 
            <img src="images/slides/4.jpg"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat"> 
            
          </li>
          
          <li data-transition="random" data-slotamount="7"> 
            <!-- MAIN IMAGE --> 
            <img src="images/slides/5.jpg"  alt=""  data-bgposition="center top" data-bgfit="cover" data-bgrepeat="no-repeat"> 
            <!-- LAYERS --> 
      ...
      <div class="items row col-4"> 
          ...
          <div class="portfolio-image"> <img class="img-responsive" alt="Open Imagination" src="images/portfolio/img-1.jpg"> <a href="images/portfolio/img-1.jpg" data-rel="prettyPhoto" class="prettyPhoto lightzoom zoom"><i class="ion-ios-search"></i></a>
            <div class="portfolio-overlay style-2">
              <div class="detail-info">
               <h3><a href="pf-d-jo">Chemical Research Test Laboratory Management System</a></h3>
                <span><a href="pf-d-jo">Java Development</a></span> </div>
            </div>
          </div>
        </article>
        ...
        <article class="portfolio-item pf-branding-design">
          <div class="portfolio-image"> <img class="img-responsive" alt="Open Imagination" src="images/portfolio/img-2.jpg"> <a href="images/portfolio/img-2.jpg" data-rel="prettyPhoto" class="prettyPhoto lightzoom zoom"><i class="ion-ios-search"></i></a>
            <div class="portfolio-overlay style-2">
              <div class="detail-info">
                <h3><a href="pf-w-admin-panel">Admin Panel</a></h3>
                <span><a href="pf-w-admin-panel">Wed Design</a></span> </div>
            </div>
          </div>
        </article>
        ...
        <article class="portfolio-item pf-web-design">
          <div class="portfolio-image"> <img class="img-responsive" alt="Open Imagination" src="images/portfolio/img-3.jpg"> <a href="images/portfolio/img-3.jpg" data-rel="prettyPhoto" class="prettyPhoto lightzoom zoom"><i class="ion-ios-search"></i></a>
            <div class="portfolio-overlay style-2">
              <div class="detail-info">
                <h3><a href="pf-d-ecco">E-commerce &amp; Survey</a></h3>
                <span><a href="pf-d-ecco">Java Development</a></span> </div>
            </div>
          </div>
        </article>
        ...
        <article class="portfolio-item pf-branding-design">
          <div class="portfolio-image"> <img class="img-responsive" alt="Open Imagination" src="images/portfolio/img-4.jpg"> <a href="images/portfolio/img-4.jpg" data-rel="prettyPhoto" class="prettyPhoto lightzoom zoom"><i class="ion-ios-search"></i></a>
            <div class="portfolio-overlay style-2">
              <div class="detail-info">
                <h3><a href="portfolio-single">Boulangerie product design</a></h3>
                <span><a href="portfolio-single">Branding &amp; Wed Design</a></span> </div>
            </div>
          </div>
        </article>
    ...
    <section class="list-style-featured light-gray-bg padding-top-80 padding-bottom-10 ">
      <div class="container"> 
        ...
        <div class="row margin-top-40"> 
    		<a href="contact" class="waves-effect waves-light btn btn-white ">Contact Us</a>
        </div>
        </div>
      </div>
    </section>
